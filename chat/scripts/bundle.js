...
var $, Contact, ContactList, ContactListView, ContactView, InputModel, InputView, LocalUserModel, LocalUserView, Message, MessageList, MessageListView, MessageView, backbone, bootstrap, codemirror, hljs, jade, marked, show_name_dialog, _, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
...
LocalUserModel = (function(_super) {
  __extends(LocalUserModel, _super);

  function LocalUserModel() {
    this.start = __bind(this.start, this);
    this.validate = __bind(this.validate, this);
    _ref = LocalUserModel.__super__.constructor.apply(this, arguments);
    return _ref;
  }
  ...
  */
  ...
  LocalUserModel.prototype.defaults = {
    name: 'anonymus',
    server_key: 0,
    peer: null
  };

  LocalUserModel.prototype.validate = function(attrs, options) {
    return null;
  };

  LocalUserModel.prototype.start = function() {
    var peer,
      _this = this;
    peer = new Peer({
      id: this.get('name'),
...
LocalUserView = (function(_super) {
  ...
  function LocalUserView() {
    ...
    _ref1 = LocalUserView.__super__.constructor.apply(this, arguments);
    return _ref1;
  }

  LocalUserView.prototype.el = $('#local-user');

  LocalUserView.prototype.initialize = function() {
    var _this = this;
    this.render();
...
InputModel = (function(_super) {
  ...
  function InputModel() {
    _ref2 = InputModel.__super__.constructor.apply(this, arguments);
    return _ref2;
  }
  ...
  */
  ...
  InputModel.prototype.initialize = function(options) {
    var _this = this;
    ...
    return this.on('data', function(data) {
      ...
      message = new Message({
        text: data,
        from: _this.local_user.get('name')
      });
      return _this.trigger('send', message);
    });
  };
...
InputView = (function(_super) {
  ...
  function InputView() {
    ...
    this.render = __bind(this.render, this);
    _ref3 = InputView.__super__.constructor.apply(this, arguments);
    return _ref3;
  }

  InputView.prototype.el = $('#input-area');

  InputView.prototype.initialize = function() {
    var _this = this;
    this.template = require('../templates/input_area.jade');
    this.render();
    this.editor = codemirror.fromTextArea($('#text-input').get(0), {
      mode: 'markdown',
      lineNumbers: true,
      firstLineNumbers: 10,
      theme: 'default',
    ...
    this.editor.on("change", function(cm, change_obj) {
    ...
    this.editor.on("keyup", function(cm, event) {
      if (event.which === 13 && event.shiftKey) {
        _this.model.trigger('data', _this.editor.getValue());
        return _this.editor.setValue("");
      }
    });
    return this.model.on('change:text', this.preview);
  };
  ...
  InputView.prototype.preview = function() {
    $('#preview').html(marked(this.model.get('text')));
    if (typeof MathJax !== "undefined" && MathJax !== null) {
      return MathJax.Hub.Queue(["Typeset", MathJax.Hub, "preview"]);
    }
  };
...
Message = (function(_super) {
  ...
  function Message() {
    _ref4 = Message.__super__.constructor.apply(this, arguments);
    return _ref4;
  }
...
MessageList = (function(_super) {
  ...
  function MessageList() {
    _ref5 = MessageList.__super__.constructor.apply(this, arguments);
    return _ref5;
  }
...
MessageView = (function(_super) {
  ...
  function MessageView() {
    this.render = __bind(this.render, this);
    _ref6 = MessageView.__super__.constructor.apply(this, arguments);
    return _ref6;
  }

  MessageView.prototype.el = '#message-list';

  MessageView.prototype.initialize = function() {
    this.template = require('../templates/message.jade');
    return this.render();
  };

  MessageView.prototype.render = function() {
    var message_data;
    message_data = this.model.toJSON();
    message_data['text'] = marked(message_data['text']);
    this.$el.append(this.template(message_data));
    if (typeof MathJax !== "undefined" && MathJax !== null) {
      return MathJax.Hub.Queue(["Typeset", MathJax.Hub, this.el]);
    }
  };
...
MessageListView = (function(_super) {
  ...
  function MessageListView() {
    this.render = __bind(this.render, this);
    _ref7 = MessageListView.__super__.constructor.apply(this, arguments);
    return _ref7;
  }

  MessageListView.prototype.el = '#log';

  MessageListView.prototype.initialize = function() {
    var _this = this;
    this.template = require('../templates/message_list.jade');
    this.render();
    return this.model.on('add', function(message) {
      var message_view;
      return message_view = new MessageView({
        model: message
      });
    });
  };
...
Contact = (function(_super) {
  ...
  function Contact() {
    this.resv = __bind(this.resv, this);
    this.send = __bind(this.send, this);
    this.connect = __bind(this.connect, this);
    _ref8 = Contact.__super__.constructor.apply(this, arguments);
    return _ref8;
  }
  ...
  */
  ...
  Contact.prototype.initialize = function(options) {
    ...
    return this.on('change:conn', function(model, conn) {
      if (_this.previous('conn') != null) {
  ...
  Contact.prototype.send = function(message) {
    var messages;
...
ContactList = (function(_super) {
  ...
  function ContactList() {
    ...
    this.find_contact = __bind(this.find_contact, this);
    _ref9 = ContactList.__super__.constructor.apply(this, arguments);
    return _ref9;
  }

  ContactList.prototype.model = Contact;

  ContactList.prototype.initialize = function(options) {
    var _this = this;
    this.active_contact = null;
    this.input = options['input'];
    this.input.on('send', function(message) {
      if (_this.active_contact != null) {
        return _this.active_contact.send(message);
      } else {
        return alert("no active contact");
      }
    });
    return this.on('select', this.activate);
  };
...
ContactView = (function(_super) {
  ...
  function ContactView() {
    this.render = __bind(this.render, this);
    _ref10 = ContactView.__super__.constructor.apply(this, arguments);
    return _ref10;
  }

  ContactView.prototype.el = '#contact-list';

  ContactView.prototype.initialize = function() {
    var _this = this;
    this.template = require('../templates/contact.jade');
    this.render();
    this.messages_view = new MessageListView({
  ...
  ContactView.prototype.render = function() {
    ...
    return this.el = '#contact-' + this.model.get('id');
  };
...
ContactListView = (function(_super) {
  ...
  function ContactListView() {
    this.request_conn = __bind(this.request_conn, this);
    this.render = __bind(this.render, this);
    this.add = __bind(this.add, this);
    _ref11 = ContactListView.__super__.constructor.apply(this, arguments);
    return _ref11;
  }

  ContactListView.prototype.el = '#contacts';

  ContactListView.prototype.initialize = function(options) {
    var _this = this;
    this.template = require('../templates/contact_list.jade');
    this.local_user = this.options['local_user'];
    this.elements = {};
    this.render();
    $('#btn-add-contact').click(function() {
      return $('#add-contact-dialog').modal('show');
    });
    $('#btn-save-contact').click(function() {
      ...
      return $('#add-contact-dialog').modal('hide');
    });
    return this.local_user.on('request_conn', this.request_conn);
  };
...
show_name_dialog = function(local_user) {
  var dialog_template, name, server_key;
  dialog_template = require('../templates/name_dialog.jade');
  $('body').append(dialog_template());
  $('#name-dialog').modal('show');
  name = $('#local-user-name');
  server_key = $('#server-key');
  return $('#btn-save-name-dialog').click(function() {
    local_user.set({
      name: name.val(),
      server_key: server_key.val()
    });
    if (!local_user.isValid()) {
      name.parent().addClass('has-error');
      return server_key.parent().addClass('has-error');
    } else {
      $('#name-dialog').modal('hide');
      return local_user.start();
    }
  });
};

$(function() {
  var active_contact, contacts, contacts_view, input_model, input_view, local_user, local_user_view, message_list_view;
  $('#sidebar').affix();
  ...
  return "local_user.on 'open', =>\n\n    local_user.on 'connection', =>\n        contact = new Contact\n\n    contacts.on 'add', (contact) =>\n        active_contact = contact\n        message_list_view = new MessageListView\n            model: active_contact.get 'messages'";
});


},{"../../node_modules/twitter-bootstrap-3.0.0/dist/js/bootstrap.js":72,"../templates/contact.jade":2,"../templates/contact_list.jade":3,"../templates/input_area.jade":4,"../templates/local_user.jade":5,"../templates/message.jade":6,"../templates/message_list.jade":7,"../templates/name_dialog.jade":8,"backbone":9,"code-mirror":10,"highlight.js":35,"jade-runtime":67,"jquery-browserify":70,"marked":71,"underscore":73}],2:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');
module.exports=function(params) { if (params) {params.require = require;} return (
function anonymous(locals) {
jade.debug = [{ lineno: 1, filename: "/home/adr/git/chat/chat/templates/contact.jade" }];
try {
var buf = [];
var locals_ = (locals || {}),id = locals_.id,name = locals_.name;jade.indent = [];


buf.push("\n<li" + (jade.attrs({ 'id':('contact-' + id), "class": [('contact')] }, {"id":true})) + ">");


buf.push("<a>");


buf.push(jade.escape(null == (jade.interp = name) ? "" : jade.interp));
...
;return buf.join("");
  ...
  jade.rethrow(err, jade.debug[0].filename, jade.debug[0].lineno,"li.contact(id='contact-' + id)\n    a\n        = name\n");
}
}
)(params); }

},{"jade/lib/runtime.js":69}],3:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');
module.exports=function(params) { if (params) {params.require = require;} return (
function anonymous(locals) {
jade.debug = [{ lineno: 1, filename: "/home/adr/git/chat/chat/templates/contact_list.jade" }];
try {
var buf = [];
jade.indent = [];
...
buf.push("\n  <button id=\"btn-add-contact\" type=\"button\" class=\"btn btn-primary\">");


buf.push("Add contact");
...
buf.push("\n<div id=\"add-contact-dialog\" class=\"modal fade\">");
...
buf.push("Name of contact");


buf.push("</label>");


buf.push("\n            <input id=\"add-contact-name\" type=\"text\" name=\"add-contact-name\" placeholder=\"Enter name\" class=\"form-control\"/>");
...
buf.push("\n            <label for=\"contact-connect-id\" class=\"control-label\">");


buf.push("Connection id");


buf.push("</label>");


buf.push("\n            <input id=\"add-contact-id\" type=\"text\" name=\"add-contact-id\" placeholder=\"Enter id of contact\" class=\"form-control\"/>");
...
buf.push("\n        <button id=\"btn-save-contact\" type=\"button\" class=\"btn btn-primary\">");
...
;return buf.join("");
  ...
  jade.rethrow(err, jade.debug[0].filename, jade.debug[0].lineno,"h4\n    | Contacts\n    button#btn-add-contact.btn.btn-primary(type='button') Add contact\n\n#add-contact-dialog.modal.fade\n    .modal-dialog\n        .modal-content\n            .modal-header\n                h4.modal-title\n                    | Add contact\n            .modal-body\n                form(role='form')\n                    .form-group\n                        label.control-label(for='contact-name') Name of contact\n                        input#add-contact-name.form-control(type='text', name='add-contact-name', placeholder='Enter name')\n                    .form-group\n                        label.control-label(for='contact-connect-id') Connection id\n                        input#add-contact-id.form-control(type='text', name='add-contact-id', placeholder='Enter id of contact')\n            .modal-footer\n                button#btn-save-contact.btn.btn-primary(type='button') Add\n\nul#contact-list\n");
}
}
)(params); }

},{"jade/lib/runtime.js":69}],4:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');
module.exports=function(params) { if (params) {params.require = require;} return (
function anonymous(locals) {
jade.debug = [{ lineno: 1, filename: "/home/adr/git/chat/chat/templates/input_area.jade" }];
try {
var buf = [];
jade.indent = [];
...
buf.push("\n      <label for=\"text-input\" class=\"control-label\">");
...
buf.push("\n      <textarea id=\"text-input\" name=\"text-input\" rows=\"6\">");
...
;return buf.join("");
  ...
  jade.rethrow(err, jade.debug[0].filename, jade.debug[0].lineno,"form(role='form')\n    .row.well\n        .col-md-6\n            label.control-label(for='text-input') Input\n            textarea#text-input(name='text-input', rows=6)\n        .col-md-6\n            label.control-label Preview\n            #preview\n");
}
}
)(params); }

},{"jade/lib/runtime.js":69}],5:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');
module.exports=function(params) { if (params) {params.require = require;} return (
function anonymous(locals) {
jade.debug = [{ lineno: 1, filename: "/home/adr/git/chat/chat/templates/local_user.jade" }];
try {
var buf = [];
var locals_ = (locals || {}),name = locals_.name,id = locals_.id,server_key = locals_.server_key;jade.indent = [];
...
buf.push("and user id");


buf.push(jade.escape(null == (jade.interp = ' ' + id + ' ') ? "" : jade.interp));


buf.push("server key is");


buf.push(jade.escape(null == (jade.interp = ' ' + server_key) ? "" : jade.interp));

;return buf.join("");
} catch (err) {
  jade.rethrow(err, jade.debug[0].filename, jade.debug[0].lineno,"| Using name\n= ' ' + name + ' '\n| and user id\n= ' ' + id + ' '\n| server key is\n= ' ' + server_key\n");
}
}
)(params); }

},{"jade/lib/runtime.js":69}],6:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');
module.exports=function(params) { if (params) {params.require = require;} return (
function anonymous(locals) {
jade.debug = [{ lineno: 1, filename: "/home/adr/git/chat/chat/templates/message.jade" }];
try {
var buf = [];
var locals_ = (locals || {}),from = locals_.from,text = locals_.text;jade.indent = [];
...
buf.push(jade.escape(null == (jade.interp = from) ? "" : jade.interp));


buf.push("\n  </h4>");


buf.push(null == (jade.interp = text) ? "" : jade.interp);
...
;return buf.join("");
  ...
  jade.rethrow(err, jade.debug[0].filename, jade.debug[0].lineno,"li\n    h4\n        = from\n    != text\n");
}
}
)(params); }

},{"jade/lib/runtime.js":69}],7:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');
module.exports=function(params) { if (params) {params.require = require;} return (
function anonymous(locals) {
jade.debug = [{ lineno: 1, filename: "/home/adr/git/chat/chat/templates/message_list.jade" }];
try {
var buf = [];
jade.indent = [];
...
;return buf.join("");
  ...
  jade.rethrow(err, jade.debug[0].filename, jade.debug[0].lineno,"ul#message-list\n");
}
}
)(params); }

},{"jade/lib/runtime.js":69}],8:[function(require,module,exports){
var jade = require('jade/lib/runtime.js');
module.exports=function(params) { if (params) {params.require = require;} return (
function anonymous(locals) {
jade.debug = [{ lineno: 1, filename: "/home/adr/git/chat/chat/templates/name_dialog.jade" }];
try {
var buf = [];
jade.indent = [];
...
buf.push("Choose user name and server");
...
buf.push("\n            <label for=\"local-user-name\" class=\"control-label\">");
...
buf.push("\n            <input id=\"local-user-name\" type=\"text\" name=\"name\" placeholder=\"Enter name\" class=\"form-control\"/>");
...
buf.push("\n            <label for=\"server-key\" class=\"control-label\">");
...
buf.push("\n            <input id=\"server-key\" type=\"text\" name=\"server-key\" class=\"form-control\"/>");
...
buf.push("\n        <button id=\"btn-save-name-dialog\" type=\"button\" class=\"btn btn-primary\">");
...
;return buf.join("");
  ...
  jade.rethrow(err, jade.debug[0].filename, jade.debug[0].lineno,"#name-dialog.modal.fade\n    .modal-dialog\n        .modal-content\n            .modal-header\n                h4.modal-title\n                    | Choose user name and server\n            .modal-body\n                form(role='form')\n                    .form-group\n                        label.control-label(for='local-user-name') Nick name\n                        input#local-user-name.form-control(type='text', name='name', placeholder='Enter name')\n                    .form-group\n                        label.control-label(for='server-key') Server key\n                        input#server-key.form-control(type='text', name='server-key')\n            .modal-footer\n                button#btn-save-name-dialog.btn.btn-primary(type='button') Save\n");
}
}
)(params); }

},{"jade/lib/runtime.js":69}],9:[function(require,module,exports){
//     Backbone.js 1.0.0
...
},{"underscore":73}],10:[function(require,module,exports){
...
},{"./codemirror.js":10}],11:[function(require,module,exports){
...
},{"./globals":66,"./jade-runtime":68}],68:[function(require,module,exports){
...
},{"fs":74}],69:[function(require,module,exports){
...
},{"fs":74}],70:[function(require,module,exports){
